...
const CTA = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-primary via-primary-light to-secondary relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-full opacity-10">
        <Leaf className="absolute top-10 left-10 w-32 h-32 animate-pulse" />
        <Heart className="absolute bottom-10 right-10 w-24 h-24 animate-pulse" style={{ animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-white/90">
            Experience the change with Venille Wipes. Together, we can create a more 
            sustainable future—one makeup wipe at a time.
          </p>
