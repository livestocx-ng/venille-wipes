...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-accent/30 to-primary/5">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              Venille Sustainable{" "}
              <span className="text-gradient-eco">Makeup Wipes</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              ...
              <div>
                <div className="text-3xl font-bold text-secondary">6 mo</div>
                <div className="text-sm text-muted-foreground">Decompose</div>
              </div>
              <div>
