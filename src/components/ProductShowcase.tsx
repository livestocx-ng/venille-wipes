      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Meet Your New <span className="text-gradient-eco">Beauty Essential</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Premium quality wipes that care for your skin while protecting the planet
          </p>
        </div>
            ...
            <CardContent className="p-0">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12 space-y-6 flex flex-col justify-center">
                  <div>
                    <h3 className="text-3xl font-bold mb-2">Venille Makeup Wipes</h3>
                    <p className="text-muted-foreground">Aloe Moisture Formula</p>
                  </div>
                  ...
                  <div className="pt-4">
                    <div className="text-3xl font-bold text-primary mb-4">30% More Affordable</div>
